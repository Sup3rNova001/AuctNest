...
public class StartAuctionTest {
  ...
  public void startAuction() {
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".product__container:nth-child(3) .MuiCardMedia-root"));
    ...
    driver.findElement(By.cssSelector(".product__container:nth-child(1) .MuiTypography-root:nth-child(1)")).click();
    {
